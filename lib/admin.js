...
function createUser(newuser) {
    ...
    var NS_U = 'com.aczire.alm.base.user.admin';

    var user = factory.newResource(NS_U, newuser.getFullyQualifiedType(), newuser.uname);
    user.uid = newuser.uid;

    // save the order
    return getAssetRegistry('com.aczire.alm.base.user.admin')
